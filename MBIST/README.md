...
- Pattern simulation: Run VCS pattern simulation with ATPG patterns w/o fault injection.
<img width="600" alt="image" src="https://github.com/user-attachments/assets/8391b28d-0558-4e38-b591-10de4887bc5f" />


 
- Pattern simulation: Run VCS pattern simulation with ATPG patterns w/ fault injection by forcing net `n1`.
