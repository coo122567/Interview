...
syn_log = "syn.log"
TSMC090_SIM = /home/m110/m110061576/process/CBDK_TSMC90GUTM_Arm_f1.0/CIC/Verilog/tsmc090.v
...
VCS_GATE_SIM = vcs -f ${gate_sim_file} \
    ...
    +define+GATE \
	+neg_tchk \
	+optconfigfile+${notimingcheck_cell}
...
clean_syn 	= rm -rf ./netlist/*_syn.v ./report/${TOP_NAME}.* *.log alib* *.svf dwsvf* *.ddc *.pvl *.syn *.mr
clean_sg 	= rm -rf ./spyglass-1 *.log *_sg.rpt
clean_fm 	= rm -rf ./FM_INFO *.log *.rpt ./formality_svf
