...
## Simulation Results
- CRC is computed in the clk2 domain and starts when start_crc is asserted.
  <img width="1200" alt="image" src="https://github.com/user-attachments/assets/20784686-2113-478b-98ae-d5cd17fca88e" />
...
- Architecture Optimized
  ...
  - Unfolding-2 CRC step(design compiler)
    <img width="800" alt="image" src="https://github.com/user-attachments/assets/10dd5fa0-0ed8-42eb-9af1-04dd7d8e474f" />
