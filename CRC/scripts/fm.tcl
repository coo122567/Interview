...
read_verilog -r "./rtl/top.v ./rtl/rst_sync2.v ./rtl/clk_1_module.v ./rtl/clk_2_module.v ./rtl/clk_3_module.v ./rtl/crc_step.v ./rtl/plsgen.v ./rtl/cdc_sync2.v ./rtl/toggleff.v"
set_top -a
